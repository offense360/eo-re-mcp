...
| [#47](https://github.com/offense360/eo-re-mcp/issues/47) | Ghidra | `parse_type_declaration` passes the CParser message through with CR LF breaks and the Java exception class prefix (cosmetic; found while verifying #39) | Open (low priority) |

...
`eo-re-mcp-ida` is not on PyPI (`pip install re-mcp-ida` installs upstream's last release). Install from the GitHub release wheels: download `eo_re_mcp_core-1.1.1-py3-none-any.whl` and `eo_re_mcp_ida-1.1.1-py3-none-any.whl` from the [releases page](https://github.com/offense360/eo-re-mcp/releases), then:
...
```bash
pip install eo_re_mcp_core-1.1.1-py3-none-any.whl eo_re_mcp_ida-1.1.1-py3-none-any.whl
```

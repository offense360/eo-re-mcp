...
uv tool install ./eo_re_mcp_core-1.2.0-py3-none-any.whl --with ./eo_re_mcp_ida-1.2.0-py3-none-any.whl --with ./eo_re_mcp_ghidra-1.2.0-py3-none-any.whl
```

With pip:

```bash
pip install eo_re_mcp_core-1.2.0-py3-none-any.whl eo_re_mcp_ida-1.2.0-py3-none-any.whl     # IDA only
pip install eo_re_mcp_core-1.2.0-py3-none-any.whl eo_re_mcp_ghidra-1.2.0-py3-none-any.whl  # Ghidra only
pip install eo_re_mcp_core-1.2.0-py3-none-any.whl eo_re_mcp_ida-1.2.0-py3-none-any.whl eo_re_mcp_ghidra-1.2.0-py3-none-any.whl  # Both backends and the unified CLI
```
...
IDADIR=/path/to/ida uvx --from ./eo_re_mcp_ida-1.2.0-py3-none-any.whl --with ./eo_re_mcp_core-1.2.0-py3-none-any.whl re-mcp-ida
GHIDRA_INSTALL_DIR=/path/to/ghidra uvx --from ./eo_re_mcp_ghidra-1.2.0-py3-none-any.whl --with ./eo_re_mcp_core-1.2.0-py3-none-any.whl re-mcp-ghidra

# Unified package
IDADIR=/path/to/ida uvx --from ./eo_re_mcp_core-1.2.0-py3-none-any.whl --with ./eo_re_mcp_ida-1.2.0-py3-none-any.whl re-mcp --backend ida
GHIDRA_INSTALL_DIR=/path/to/ghidra uvx --from ./eo_re_mcp_core-1.2.0-py3-none-any.whl --with ./eo_re_mcp_ghidra-1.2.0-py3-none-any.whl re-mcp --backend ghidra
```
...
# Unified package
$env:IDADIR = "C:\Program Files\IDA Professional 9.3"
uvx --from ./eo_re_mcp_core-1.2.0-py3-none-any.whl --with ./eo_re_mcp_ida-1.2.0-py3-none-any.whl re-mcp --backend ida
```
...
**Using the unified `re-mcp` CLI (when installed via `uv tool install ./eo_re_mcp_core-1.2.0-py3-none-any.whl --with ./eo_re_mcp_ida-1.2.0-py3-none-any.whl`):**
